...
bits dataToBytes(int cas, char* aux){
  bits z;
  z.a=0;
  z.b=0;
  z.c=0;
  ...
  case 31:
    ...
    pos=7;  
    while(pos>=0){
      bitWrite(z.d,pos,(int)aux[cont]);
      //Serial.print(aux[cont]);
      pos--;
      cont--;
    }
    //Serial.println("->d");
...
int aPrinter(data a){
   ...
   char aux[32];
   while (c<60){
    String b=String (a.val[c],BIN);
    b.toCharArray(aux,32);
    res=dataToBytes(a.tam[c],aux);
    switch(a.tam[c]){
      case 4:
        Serial.print(res.a,BIN);
        Serial.print(res.b,BIN);
        Serial.print(res.c,BIN);
        Serial.print(res.d,BIN);
        cksum+=4;
        break;
      case 3:
        Serial.print(res.a,BIN);
...
void aReciever(tEcu dataSender,tEcu dataReciever){
  ...
  dataReciever.pulseWidth1=llegirposicio(2,2,1,respuesta);
  dataReciever.pulseWidth2=llegirposicio(2,4,1,respuesta);
  dataReciever.rpms=llegirposicio(2,6,1,respuesta);
  dataReciever.advance=llegirposicio(2,8,1,respuesta);
  dataReciever.squirt=llegirposicio(1,1,1,respuesta);
  dataReciever.engine=llegirposicio(1,11,1,respuesta);
  dataReciever.afrtgt1=llegirposicio(1,12,1,respuesta);
  dataReciever.afrtgt2=llegirposicio(1,13,1,respuesta);
  dataReciever.wbo2_en1=llegirposicio(1,14,1,respuesta);
  dataReciever.wbo2_en2=llegirposicio(1,15,1,respuesta);
  dataReciever.barometer=llegirposicio(2,16,1,respuesta);
  dataReciever.mapp=llegirposicio(2,18,1,respuesta);
  dataReciever.matt=llegirposicio(2,20,1,respuesta);
  dataReciever.coolant=llegirposicio(2,22,1,respuesta);
  dataReciever.tpss=llegirposicio(2,24,1,respuesta);
  dataReciever.batteryVoltage=llegirposicio(2,26,1,respuesta);
  dataReciever.afr1=llegirposicio(2,28,1,respuesta);
  dataReciever.afr2=llegirposicio(2,30,1,respuesta);
  dataReciever.knock=llegirposicio(2,32,1,respuesta);
  dataReciever.egocor1=llegirposicio(2,34,1,respuesta);
  dataReciever.egocor2=llegirposicio(2,36,1,respuesta);
  dataReciever.aircor=llegirposicio(2,38,1,respuesta);
  dataReciever.warmcor=llegirposicio(2,40,1,respuesta);
  dataReciever.accelEnrich=llegirposicio(2,42,1,respuesta);
  dataReciever.tpsfuelcut=llegirposicio(2,44,1,respuesta);
  dataReciever.baroCorrection=llegirposicio(2,46,1,respuesta);
  dataReciever.gammaEnrich=llegirposicio(2,48,1,respuesta);
  dataReciever.ve1=llegirposicio(2,50,1,respuesta);
  dataReciever.ve2=llegirposicio(2,52,1,respuesta);
  dataReciever.iacstep=llegirposicio(2,54,1,respuesta);
  dataReciever.cold_adv_deg=llegirposicio(2,56,1,respuesta);
  dataReciever.TPSdot=llegirposicio(2,58,1,respuesta);
  dataReciever.MAPdot=llegirposicio(2,60,1,respuesta);
  dataReciever.dwell=llegirposicio(2,62,1,respuesta);
  dataReciever.MAFFF=llegirposicio(2,64,1,respuesta);
  dataReciever.fuelload=llegirposicio(1,66,1,respuesta);
  dataReciever.fuelcor=llegirposicio(2,68,1,respuesta);
  dataReciever.portStatus=llegirposicio(1,70,1,respuesta);
  dataReciever.knockRetard=llegirposicio(2,71,1,respuesta);
  dataReciever.EAEfcor1=llegirposicio(2,72,1,respuesta);
  dataReciever.egoV1=llegirposicio(2,74,1,respuesta);
  dataReciever.egoV2=llegirposicio(2,76,1,respuesta);
  ...
  dataReciever.spare9=llegirposicio(2,1,1,respuesta);
  dataReciever.spare10=llegirposicio(2,12,1,respuesta);
  dataReciever.tachCount=llegirposicio(2,14,1,respuesta);
  dataReciever.ospare=llegirposicio(1,16,1,respuesta);
  dataReciever.cksum=llegirposicio(2,17,1,respuesta);
  dataReciever.deltaT=llegirposicio(4,18,1,respuesta);
  int ans=0,ro=0;
